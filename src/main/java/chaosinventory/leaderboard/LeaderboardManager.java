...
public class LeaderboardManager {
    ...
    public static List<String> getLeaderboard(Player requestor) {
        ...
        String playerName = requestor.getName().getString();
        ...
        if (requestorStats != null) {
            ...
            if (playerRank > 10) {
                ...
                result.add("§e#" + playerRank + " §7" + requestorStats.name);
    ...
    private static String getRankColor(int rank) {
        switch (rank) {
            case 1: return "§6§l";  // Oro
            case 2: return "§7§l";  // Argento
            case 3: return "§6§l";  // Bronzo
            default: return "§e";
        }
    }
}